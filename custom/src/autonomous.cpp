...
void _L4B() {
    ...
    // Start Scraper Thread and Intake
    //thread dsjfld = thread(scraperthread3);
    intake.spin(forward, 100, percent);
    turnToAngle(-13,500,true,10);

    // Collect 3 Blocks
    moveToPoint(-6.5,29,1,2000,true,4,false); wait(200,msec);
    ...
    // Turn towards Long Goal
    turnToAngle(65,3000,true,6); wait(1000,msec);

    // Align
    driveTo(-600,2000,true,12);

    // Safety Align
    driveTo(-300,1000,true,12); wait(100,msec);
