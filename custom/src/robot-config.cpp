...
double distance_kp = 1.35, distance_ki = 0.02, distance_kd = 21.1;
double turn_kp = 0.85, turn_ki = 0.01, turn_kd = 8.05;
double heading_correction_kp = 1.2, heading_correction_ki = 0.01, heading_correction_kd = 8.77;
...
double max_slew_accel_fwd = 9;
double max_slew_decel_fwd = 9;
double max_slew_accel_rev = 9;
double max_slew_decel_rev = 9;
